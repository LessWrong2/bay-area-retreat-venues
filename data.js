...
window.VENUES = [
 ...
 },
 {
  ...
  "watch": "Mixed lodging from private rooms to dorms; rates are not published anywhere, so everything starts with an inquiry form. Church-owned (First Presbyterian Portland) though it rents to secular groups. Airport check: 32 minutes from PDX, measured — just over the half-hour bar, but it is one straight run east on I-84.",
  "phone": "(503) 695-2243",
 ...
 },
 {
  ...
  "watch": "The airport that is genuinely close (Pangborn/EAT) only flies to Seattle; the practical route is SFO→SEA and a 2 h 20 drive over Stevens Pass. Leavenworth is a Bavarian-theme tourist town in high season. Airport check: this one fails the proximity brief badly — nearly three hours from SEA, measured. Wenatchee is 56 minutes away but has no nonstop from the Bay Area, so 60 people would fly SFO–SEA–EAT or drive the Cascades.",
  "phone": "(509) 548-6344",
  "email": "",
  ...
  "region": "west",
  "airport": "SEA · 2 hr 57 min / 128 mi (EAT · 56 min, but EAT has no Bay Area nonstop)",
  "flights": "Nonstop SFO–SEA on United, Alaska and Delta; nonstop OAK–SEA on Alaska. Wenatchee (EAT) is far closer to the property but only connects through SEA.",
  "tierLabel": "Tier C",
 ...
 },
 {
  ...
  "watch": "Not exclusive-use, and the site's own copy pitches curated retreats for 10–50, so 60 needs a conversation. Cottages have kitchens but the lodging is spread across many small buildings. Boulder in October can be cold. Airport check: 52 minutes from DEN, measured — well over the bar, though it is a single straight drive and coaches on that run are easy to charter.",
  "phone": "",
  "email": "",
  ...
  "region": "west",
  "airport": "DEN · 52 min / 42 mi",
  "flights": "Nonstop SFO–DEN on United; nonstop OAK–DEN on Southwest (year-round)",
  "tierLabel": "Tier C",
 ...
 },
 {
  ...
  "watch": "Two-leg travel from the Bay Area (SEA plus a small plane or a ferry). The mansion is the beautiful part; the guest lodging is ordinary resort-village building stock, and the resort's own gallery could not be scraped, so the photos here are all Wikimedia Commons shots of the mansion. Airport check: the worst on the list for logistics. Road and ferry is three and a half hours from SEA, and the seaplane is charming for six people and a scheduling problem for 60.",
  "phone": "(360) 376-2222",
  "email": "",
  ...
  "region": "west",
  "airport": "SEA · 3 hr 36 min / 124 mi by road and ferry; the resort has its own seaplane dock",
  "flights": "Nonstop SFO–SEA on United, Alaska and Delta; nonstop OAK–SEA on Alaska. Kenmore Air flies SEA to the resort dock, but on small floatplanes.",
  "tierLabel": "Tier C",
 ...
 },
 {
  ...
  "watch": "The most expensive option here, and lodging is spread between the Inn, cottages and mountain homes rather than one campus. Redford sold his stake in 2020. A whole-village hold at 60 people is unconfirmed. Airport check: 73 minutes from SLC, measured — more than double the bar. Provo airport is nearer but does not have a nonstop from SFO or OAK.",
  "phone": "(800) 892-1600",
  "email": "",
  ...
  "region": "west",
  "airport": "SLC · 1 hr 13 min / 56 mi (Provo is closer but has no Bay Area nonstop)",
  "flights": "Nonstop SFO–SLC on United and Delta; nonstop OAK–SLC on Southwest and Delta Connection (year-round)",
  "tierLabel": "Tier C",
